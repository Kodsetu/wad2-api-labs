...
//Add a task
router.post('/', (req, res) => {
    const { title, description, deadline, priority, created_at, updated_at, done } = req.body;
    const newTask = {
        id: uuidv4(),
        title,
        description,
...
router.put('/:id', (req, res) => {
    ...
    const updatedTask = { ...tasksData.tasks[taskIndex], ...req.body, id:id, updated_at: new Date()};
